...
model_types = ["llama", "qwen", "qwen3"] #["llama", "qwen", "qwen3"]
model_size = "3b" # 7b / 8b
...
if __name__ == "__main__":
    for bias_type in bias_types:
        for split in splits:
            ...
            bash_script = f"/nethome/yifwang/fairness_x_explainability/new_fairness_explainability/decoder_scripts_{data}/generate_explanations_{bias_type}_{split}.sh"
