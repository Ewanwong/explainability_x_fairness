...
if __name__ == "__main__":
    for bias_type in bias_types:
        for split in splits:
            ...
            bash_script = f"/nethome/yifwang/fairness_x_explainability/new_fairness_explainability/other_scripts/compute_sensitive_feature_reliance_{bias_type}_{split}.sh"
