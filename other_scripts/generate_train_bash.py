...
debiasing_methods = ["no_debiasing", "group_balance", "group_class_balance", "cda"]
...
for bias_type in bias_types:
    ...
    bash_script = f"/nethome/yifwang/fairness_x_explainability/new_fairness_explainability/other_scripts/train_models_{bias_type}.sh"
    with open(bash_script, "w") as f:
        f.write("#!/bin/bash\n")
        for model_type in model_types:
            for debiasing_method in debiasing_methods:
                model_dir = f"{model_dir_root}/{model_type}_civil_{bias_type}/{debiasing_method}"
