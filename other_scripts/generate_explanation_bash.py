...
if __name__ == "__main__":
    for bias_type in bias_types:
        for split in splits:
            ...
            bash_script = f"/nethome/yifwang/fairness_x_explainability/new_fairness_explainability/other_scripts/generate_explanations_{bias_type}_{split}.sh"
            with open(bash_script, "w") as f:
                ...
                for model_type in model_types:
                    for debiasing_method in debiasing_methods:
                        ...
                        """
                        model_dir = f"{model_dir_root}/{model_type}_civil_all/{debiasing_method}"
