...
splits = ["val"]
bias_types = ["gender",] # ["race", "gender", "religion"]
model_types = ["roberta",] # ["bert", "roberta", "distilbert"]
...
num_examples_dict_val_list = [{"race": 200, "gender": 200, "religion": 200}] # [{"race": 20, "gender": 20, "religion": 20}, {"race": 50, "gender": 50, "religion": 50}, {"race": 100, "gender": 100, "religion": 100},{"race": 200, "gender": 200, "religion": 200}, {"race": 500, "gender": 500}]
seeds = {20: list(range(1, 20))+[42], 50: list(range(1, 10))+[42], 100: [1,2,3,4,5,42], 200: [42], 500: [1,2,3,4,5,42]}
if data == "civil":
...
model_dir_root = f"/scratch/yifwang/new_fairness_x_explainability/new_debiased_models_{data}"
test_output_dir_root = f"/scratch/yifwang/new_fairness_x_explainability/encoder_results_{data}"
val_output_dir_root = f"/scratch/yifwang/new_fairness_x_explainability/encoder_results_{data}/val_results"
...
if __name__ == "__main__":
    for bias_type in bias_types:
        bash_script = f"/nethome/yifwang/fairness_x_explainability/new_fairness_explainability/other_scripts/model_selection_{bias_type}.sh"
