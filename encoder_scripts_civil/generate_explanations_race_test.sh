...
python -m explanation_generation.gen_explanation_encoder \
    ...
    --output_dir="/scratch/yifwang/new_fairness_x_explainability/encoder_results/bert_civil_race_race_test_2000/dropout" \
    --baseline="pad" \
    --bias_type="race" \
    --seed=42 \
...
python -m explanation_generation.gen_explanation_encoder \
    ...
    --num_examples=2000 \
    --methods="Attention, Saliency, DeepLift, InputXGradient, KernelShap, Occlusion, IntegratedGradients" \
    --output_dir="/scratch/yifwang/new_fairness_x_explainability/encoder_results/bert_civil_race_race_test_2000/attention_entropy" \
    --baseline="pad" \
    --bias_type="race" \
    --seed=42 \
    --only_predicted_class
...
python -m explanation_generation.gen_explanation_encoder \
    ...
    --num_examples=2000 \
    --methods="Attention, Saliency, DeepLift, InputXGradient, KernelShap, Occlusion, IntegratedGradients" \
    --output_dir="/scratch/yifwang/new_fairness_x_explainability/encoder_results/bert_civil_race_race_test_2000/causal_debias" \
    --baseline="pad" \
    --bias_type="race" \
    --seed=42 \
    --only_predicted_class
...
python -m explanation_generation.gen_explanation_encoder \
    ...
    --num_examples=2000 \
    --methods="Attention, Saliency, DeepLift, InputXGradient, KernelShap, Occlusion, IntegratedGradients" \
    --output_dir="/scratch/yifwang/new_fairness_x_explainability/encoder_results/roberta_civil_race_race_test_2000/dropout" \
    --baseline="pad" \
    --bias_type="race" \
    --seed=42 \
    --only_predicted_class
...
python -m explanation_generation.gen_explanation_encoder \
    ...
    --num_examples=2000 \
    --methods="Attention, Saliency, DeepLift, InputXGradient, KernelShap, Occlusion, IntegratedGradients" \
    --output_dir="/scratch/yifwang/new_fairness_x_explainability/encoder_results/roberta_civil_race_race_test_2000/attention_entropy" \
    --baseline="pad" \
    --bias_type="race" \
    --seed=42 \
    --only_predicted_class
...
python -m explanation_generation.gen_explanation_encoder \
    ...
    --num_examples=2000 \
    --methods="Attention, Saliency, DeepLift, InputXGradient, KernelShap, Occlusion, IntegratedGradients" \
    --output_dir="/scratch/yifwang/new_fairness_x_explainability/encoder_results/roberta_civil_race_race_test_2000/causal_debias" \
    --baseline="pad" \
    --bias_type="race" \
    --seed=42 \
    --only_predicted_class
...
python -m explanation_generation.gen_explanation_encoder \
    ...
    --num_examples=2000 \
    --methods="Attention, Saliency, DeepLift, InputXGradient, KernelShap, Occlusion, IntegratedGradients" \
    --output_dir="/scratch/yifwang/new_fairness_x_explainability/encoder_results/distilbert_civil_race_race_test_2000/dropout" \
    --baseline="pad" \
    --bias_type="race" \
    --seed=42 \
    --only_predicted_class
...
python -m explanation_generation.gen_explanation_encoder \
    ...
    --num_examples=2000 \
    --methods="Attention, Saliency, DeepLift, InputXGradient, KernelShap, Occlusion, IntegratedGradients" \
    --output_dir="/scratch/yifwang/new_fairness_x_explainability/encoder_results/distilbert_civil_race_race_test_2000/attention_entropy" \
    --baseline="pad" \
    --bias_type="race" \
    --seed=42 \
    --only_predicted_class
...
python -m explanation_generation.gen_explanation_encoder \
    ...
    --num_examples=2000 \
    --methods="Attention, Saliency, DeepLift, InputXGradient, KernelShap, Occlusion, IntegratedGradients" \
    --output_dir="/scratch/yifwang/new_fairness_x_explainability/encoder_results/distilbert_civil_race_race_test_2000/causal_debias" \
    --baseline="pad" \
    --bias_type="race" \
    --seed=42 \
    --only_predicted_class
