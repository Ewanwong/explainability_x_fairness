...
python -m model_selection.debiasing_preprocessing \
    ...
    --num_labels=2 \
    --output_dir="/scratch/yifwang/new_fairness_x_explainability/new_debiased_models_jigsaw/bert_jigsaw_race" \
    --batch_size=8 \
    --max_seq_length=512 \
    --learning_rate=2e-05 \
...
python -m model_selection.debiasing_preprocessing \
    ...
    --dataset_name="google/jigsaw_unintended_bias" \
    --num_labels=2 \
    --output_dir="/scratch/yifwang/new_fairness_x_explainability/new_debiased_models_jigsaw/roberta_jigsaw_race" \
    --batch_size=8 \
    --max_seq_length=512 \
    --learning_rate=2e-05 \
    --warmup_steps_or_ratio=0.1 \
...
python -m model_selection.debiasing_preprocessing \
    ...
    --dataset_name="google/jigsaw_unintended_bias" \
    --num_labels=2 \
    --output_dir="/scratch/yifwang/new_fairness_x_explainability/new_debiased_models_jigsaw/distilbert_jigsaw_race" \
    --batch_size=8 \
    --max_seq_length=512 \
    --learning_rate=2e-05 \
    --warmup_steps_or_ratio=0.1 \
