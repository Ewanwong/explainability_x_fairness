...
python -m model_selection.compute_model_selection_correlation \
    --results_dir="/scratch/yifwang/fairness_x_explainability/encoder_results_jigsaw" \
    --val_results_dir="/scratch/yifwang/fairness_x_explainability/encoder_results_jigsaw/val_results" \
