...
def compute_reliance_scores_w_abs_attribution(attribution_results):
    ...
    for key in RELIANCE_KEYS:
        ...
        reliance_sum = sum(reliance_scores)
        if reliance_sum > 0:
            reliance_scores = [abs(score) for score in reliance_scores]
        else:
            reliance_scores = [-abs(score) for score in reliance_scores]
    ...
    for method in methods:
        ...
        for group in groups:
            ...
            for aggregation in aggregations:
                ...
                group_positive_prediction_reliance_scores = compute_reliance_scores_w_abs_attribution(positive_prediction_attributions)
                group_negative_prediction_reliance_scores = compute_reliance_scores_w_abs_attribution(negative_prediction_attributions)
